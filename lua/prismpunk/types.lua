...
---@field overrides? fun(colors: PrismpunkColors): table<string, vim.api.keyset.highlight>
...
---@class PrismpunkGroups
---@field [string] vim.api.keyset.highlight

---@class PrismpunkColors
---@field palette? PaletteColors
---@field theme ThemeColors

---@class PaletteColors
-- (kept the full list you provided; shortened here for brevity)
---@field sumiInkn1? ColorSpec
---@field sumiInk0? ColorSpec
---@field sumiInk1? ColorSpec
-- ... keep all fields from your original spec (copy/paste full list into this file)
