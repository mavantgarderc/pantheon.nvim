...
M.get = function(opts, plt)
  return {
    ...
    ui = {
      ...
      border = plt.control_gold,
      header1 = plt.regime_gold,
      header2 = plt.neural_red,
      special = plt.holt_teal,
      nontext = plt.regime_void,
      whitespace = plt.neural_glow,
      win_separator = plt.control_gold,
