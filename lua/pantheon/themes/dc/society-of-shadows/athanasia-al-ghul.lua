...
return {
  ...
  base16 = {
    ...
    base07 = palette.accentCyan,
    base08 = palette.dangerRed,
    base09 = palette.accentCyan,
    base0A = palette.accentCyan,
  ...
  semantic = {
    ...
    ui = {
      ...
      line_nr_active = palette.accentCyan,
    },

    diag = {
      error = palette.dangerRed,
      warning = palette.accentCyan,
      info = palette.infoBlue,
      hint = palette.tealGlow,
    },

    git = {
      add = palette.accentCyan,
