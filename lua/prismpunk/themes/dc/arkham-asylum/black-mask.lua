...
M.get = function(opts, plt)
  return {
    ...
    ui = {
      ...
      border = plt.sionis_silver,
      header1 = plt.torture_red,
      header2 = plt.mafia_suit,
      special = plt.blood_mask,
      nontext = plt.gotham_night,
      whitespace = plt.underworld_glow,
      win_separator = plt.sionis_silver,
