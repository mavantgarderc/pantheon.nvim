...
M.get = function(opts, plt)
  return {
    ...
    ui = {
      ...
      border = plt.dirty_gold,
      header1 = plt.cobblepot_gold,
      header2 = plt.ember_orange,
      special = plt.cobblepot_purple,
      nontext = plt.lounge_void,
      whitespace = plt.cigarette_glow,
      win_separator = plt.dirty_gold,
